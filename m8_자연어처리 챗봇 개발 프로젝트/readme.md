...
또한 프로젝트에서 핵심적인 기술로 사용된 RAG와 임베딩 방법, 그리고 Langchain과 LangSmith와 같은 도구에 대해서도 깊이 공부했습니다. 이 기술들은 AI 에이전트 개발과 관련된 중요한 요소들이었고, 특히 AI가 정확하고 최신 정보를 제공하는 데 필수적인 부분이었습니다. 하지만 면접 준비로 인해 이 부분에 대해 충분한 시간을 할애하지 못한 점이 아쉬움으로 남습니다.
